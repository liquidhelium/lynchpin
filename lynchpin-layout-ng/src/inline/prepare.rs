...
impl<'a> Preparation<'a> {
    ...
    pub fn slice(&self, sliced: Range) -> impl Iterator<Item = (usize, &(Range, Item<'a>))> {
        ...
        self.items
            ...
            .enumerate()
            .skip(start)
            .take_while(move |(_, (range, _))| range.start < sliced.end || range.end <= sliced.end)
    }
}
