...
fn large_op_fragment(ch: char, ctx: &TermMathContext) -> TermMathFrameFragment {
    ...
    let frame = match ch {
        '\u{2211}' => operators::build_sum_operator(mode, lynchpin_library::frame::Row::new(1)),
        '\u{222B}' => operators::build_integral_operator(mode, lynchpin_library::frame::Row::new(2)),
